    ...
    <div class="container">
        ...
        <div class="attendance-index">
            ...
            <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" >
                ...
                <?php
                if($fetch_data){ foreach ($fetch_data->result() as $rs) { ?>
                <form id="w0" action="<?php echo base_url();?>updating_users/<?php echo $rs->user_id;?>" method="post">
                    ...
                    <div class="form-group field-shift-employee_id required">
                        ...
                        <input type="text" id="shift-start_time" class="form-control" name="user_name" value="<?php echo $rs->user_name;?>" readonly>

                        <div class="help-block"></div>
                    </div>

                    <div class="form-group field-shift-day required">
                        <label class="control-label" for="shift-start_time">New Password</label>
                        <input type="password" id="shift-start_time" class="form-control" name="user_password" value="">

                        <div class="help-block"></div>
                    </div>
                    <div class="form-group field-shift-day required">
                        <label class="control-label" for="shift-start_time">Confirm New Password</label>
                        <input type="password" id="shift-start_time" class="form-control" name="user_cpassword" value="">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-success">Update User</button>    </div>
