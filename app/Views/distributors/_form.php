...
<div class="wrap">
    ...
    <div class="container">
        <ul class="breadcrumb"><li><a href="<?php echo base_url();?>dashboard">Home</a></li>
            <li class="active">Distributors List</li>
        </ul>
        <div class="attendance-index">
            <div class="pull-right">
                <p>
                    <a class="btn btn-success" href="<?php echo base_url();?>create_distributors">Create Distributors</a>
                </p>
            </div>
            ...
            <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" >
                ...
                <table id="datatable"  class="table table-striped table-bordered table-hover">
                    <thead>
                    <tr>
                        <th class="kv-align-center kv-align-middle">Distributors ID</th>
                        <th class="kv-align-center kv-align-middle">Distributors Name</th>
                    ...
                    if($fetch_data){
                        ...
                        foreach ($fetch_data->result() as $rs) {
                            ?>
                            <tr>
                                <td class="kv-align-center kv-align-middle" style="width: 250px;"><?php echo $rs->distributor_id;?></td>
                                <td class="kv-align-center kv-align-middle"><?php echo $rs->name;?></td>

                                <td class="kv-align-center kv-align-middle">
                                    <a href="<?php echo base_url();?>update_distributors/<?php echo $rs->distributor_id ;?>" title="Update" aria-label="Update" data-pjax="0">
                                        <span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                    <a href="<?php echo base_url();?>delete_distributors/<?php echo $rs->distributor_id;?>"
