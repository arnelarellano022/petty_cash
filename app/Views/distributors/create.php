...
<head>
    ...
    <title>Create Distributors</title>
...
<div class="wrap">
    ...
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url();?>distributors_index">Distributors List</a></li>
            <li class="active">Create Distributors</li>
        </ul>
        ...
        <div class="attendance-index">
            ...
            <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" >
                ...
                <form id="w0" action="<?php echo base_url();?>insert_distributors" method="post">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-success">Add Distributors</button>
                    </div>
