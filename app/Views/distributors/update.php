...
<div class="wrap">
    ...
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="<?php echo base_url();?>distributors_index">Distributors Management</a></li>
            <li class="active">Update Distributors</li>
        </ul>

        <div class="attendance-index">

            <h1>Update Distributors</h1>
            ...
            <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" >
                ...
                <form id="w0" action="<?php echo base_url();?>distributors/updating_distributors/<?php echo $rs->distributor_id;?>" method="post">

                    <div class="form-group  required">
                        <label class="control-label" >ID</label>
                        <input type="text" class="form-control" name="id" value="<?php echo $rs->distributor_id;?>" readonly>
                        <div class="help-block"></div>
                    </div>
                    <div class="form-group  required">
                        <label class="control-label" >Distributors Name</label>
                        <input type="text"  class="form-control" name="name" value="<?php echo $rs->name;?>">

                        <div class="help-block"></div>
                    </div>
                    <div class="form-group">
                        <button type="submit" class="btn btn-success">Update Distributors</button>
                    </div>
