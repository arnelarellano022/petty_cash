        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="d-inline-block float-right">
                    <a href="<?=  base_url('add_petty_cash');?>" class="btn btn-success"><i class="fa fa-plus"></i> <b>ADD NEW TRANSACTION</b></a>
                </div>
                <?php } ?>
            </div>
            ...
            <div class="card-body">
                <table id="example" class="table table-bordered table-striped">
                    ...
                    <?php if($fetch_data){foreach ($fetch_data as $row) {?>
                        <tr>
                            <td style="text-align: center"><?= $row->petty_cash_id;?></td>
                        ...
                        <?php } if($delete_access == 1){?>
                                <a href="<?php echo base_url("delete_petty_cash/". $row->petty_cash_id); ?>" class="btn btn-danger btn-xs mr5 "   data-confirm="Are you sure you want to delete this record?">
