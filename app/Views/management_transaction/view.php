                                ...
                                <div class ="row">
                                    <div class=" col-sm-8" style="margin-left: auto; margin-right: auto" >
                                        <table class="table table-bordered" style="text-align: center; font-size: large" >
                                            ...
                                            <tr>
                                                <th style="width: 50%; background-color: #F4FAFD" colspan="1" >DATE</th><th colspan="5"><?= $row->date ?></th>
                                            </tr>
                                            <tr>
                                        ...
                                        <table class="table table-bordered" style="text-align: center; font-size: large" >
                                            ...
                                            <tr>
                                                <th style="width: 25%;background-color: #F4FAFD">CREATED BY</th><th style="width: 25%" colspan="2"><?= get_user_role($row->created_by)  ?></th> <th style="width: 25%;background-color: #F4FAFD">CREATED AT</th><th style="width: 25%" colspan="2"><?= $row->created_at ?></th>
                                            </tr>
                                            <tr>
                                                <th style="width: 25%;background-color: #F4FAFD">UPDATED BY</th><th style="width: 25%" colspan="2"><?= get_user_role($row->updated_by) ?></th> <th style="width: 25%;background-color: #F4FAFD">UPDATED AT</th><th style="width: 25%" colspan="2"><?= $row->updated_at ?></th>
                                            </tr>
                                        </table>
