    ...
    <div class="container">
        ...
        <div class="attendance-index">
            <div class="pull-right" style="margin-top: 50px">
                <p>
                    <a class="btn btn-success" href="<?php echo base_url();?>create_products">Create Products</a>
                </p>
            </div>
            <h1>Products List</h1>
            <br><br>
            <div id="notif_fade" class="col-md-12">
                <?php if(isset($_SESSION["delete"])){echo '<div class="alert alert-success">'.$_SESSION["delete"].'</div>';}?>
            ...
            <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" >
                ...
                <table id="datatable"  class="table table-striped table-bordered table-hover">
                    ...
                    <tr>
                        ...
                        <th class="kv-align-center kv-align-middle">SKU</th>
                        <th class="kv-align-center kv-align-middle">Category</th>
                        <th class="kv-align-center kv-align-middle">Sub-Category</th>
                        <th class="kv-align-center kv-align-middle">Description</th>
                        <th class="kv-align-center kv-align-middle"></th>
                    </tr>
                    </thead>
                    ...
                    if($fetch_data){
                        ...
                        foreach ($fetch_data->result() as $rs) {$row_count++;
                            ...
                            <tr>
                                ...
                                <td class="kv-align-center kv-align-middle"><?php echo $rs->category;?></td>
                                <td class="kv-align-center kv-align-middle"><?php echo $rs->sub_category;?></td>
                                <td class="kv-align-center kv-align-middle"><?php echo $rs->description;?></td>

                                <td class="kv-align-center kv-align-middle">
                                    <a href="<?php echo base_url(); ?>view_products/<?php echo $rs->sku; ?>"
                                       title="View" data-pjax="0">
                                        <span class="glyphicon glyphicon-eye-open"></span>
                                    </a>
                                    <a href="<?php echo base_url();?>update_products/<?php echo $rs->sku ;?>" title="Update" aria-label="Update" data-pjax="0">
                                        <span class="glyphicon glyphicon-pencil"></span>
                                    </a>
                                    <a href="<?php echo base_url();?>delete_products/<?php echo $rs->sku;?>"
