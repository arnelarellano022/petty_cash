    ...
    <div class="container">
        ...
        <div class="attendance-index">
            ...
            <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" >
                ...
                <form id="w0" action="<?php echo base_url();?>products/updating_products/<?php echo $rs->sku;?>" method="post">

                    <div class="form-group  required">
                        <label class="control-label" >SKU</label>
                        <input type="text" class="form-control" name="sku" value="<?php echo $rs->sku;?>" >
                        <div class="help-block"></div>
                    </div>

                    <div class="form-group  required">
                        <label class="control-label" >category</label>
                        <input type="text"  class="form-control" name="category" value="<?php echo $rs->category;?>">
                    ...
                    <div class="form-group  required">
                        ...
                        <input type="text"  class="form-control" name="sub_category" value="<?php echo $rs->sub_category;?>">
                    ...
                    <div class="form-group  required">
                        ...
                        <input type="text"  class="form-control" name="description" value="<?php echo $rs->description;?>">
