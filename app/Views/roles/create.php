    ...
    <div class="container">
        ...
        <div class="attendance-index">
            ...
            <div id="w0" data-pjax-container="" data-pjax-push-state data-pjax-timeout="1000" >
                ...
                <form id="w0" action="<?php echo base_url();?>insert_roles" method="post">
                    ...
                    <div class="form-group field-shift-start_time required">
                        <label class="control-label" for="shift-start_time">Roles</label>
                        <input type="text" id="shift-start_time" class="form-control" name="roles">
